...
/**
 * Describes an option for creating Telegram Premium gift codes or Telegram Premium giveaway. Use telegramPaymentPurposePremiumGiftCodes or
 * telegramPaymentPurposePremiumGiveaway for out-of-store payments.
 */
class PremiumGiftCodePaymentOption extends TdObject
{
    public const TYPE_NAME = 'premiumGiftCodePaymentOption';
    ...
    public static function fromArray(array $array): PremiumGiftCodePaymentOption
    {
        return new static(
            $array['currency'],
            $array['amount'],
