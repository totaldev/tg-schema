...
{
    public const string TYPE_NAME = 'inputPassportElementTemporaryRegistration';
    ...
    {
        return new static(
            temporaryRegistration: TdSchemaRegistry::fromArray($array['temporary_registration']),
        );
    }
    ...
    public function setTemporaryRegistration(InputPersonalDocument $value): static
    {
    ...
    public function typeSerialize(): array
    {
        return [
            ...
            'temporary_registration' => $this->temporaryRegistration->jsonSerialize(),
        ];
    }
}
