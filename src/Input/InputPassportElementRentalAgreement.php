...
{
    public const string TYPE_NAME = 'inputPassportElementRentalAgreement';
    ...
    {
        return new static(
            rentalAgreement: TdSchemaRegistry::fromArray($array['rental_agreement']),
        );
    }
    ...
    public function setRentalAgreement(InputPersonalDocument $value): static
    {
    ...
    public function typeSerialize(): array
    {
        return [
            ...
            'rental_agreement' => $this->rentalAgreement->jsonSerialize(),
        ];
    }
}
