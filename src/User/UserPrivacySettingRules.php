...
{
    public const string TYPE_NAME = 'userPrivacySettingRules';
    ...
    {
        return new static(
            rules: array_map(static fn($x) => TdSchemaRegistry::fromArray($x), $array['rules']),
        );
    }
    ...
    public function setRules(array $value): static
    {
        $this->rules = $value;
    ...
    public function typeSerialize(): array
    {
        return [
            ...
            'rules' => array_map(static fn($x) => $x->jsonSerialize(), $this->rules),
        ];
    }
}
