...
{
    public const string TYPE_NAME = 'messageTopicDirectMessages';
    ...
    public function setDirectMessagesChatTopicId(int $value): static
    {
        $this->directMessagesChatTopicId = $value;
